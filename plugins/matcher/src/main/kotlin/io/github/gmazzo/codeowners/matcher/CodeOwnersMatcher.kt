...
public class CodeOwnersMatcher(
    ...
    public fun ownerOf(file: File, isDirectory: Boolean = file.isDirectory): Set<String>? =
        ownerOf(file.toRelativeString(rootDir), isDirectory)

    public fun ownerOf(relativePath: String, isDirectory: Boolean = relativePath.endsWith('/')): Set<String>? =
